    ...
    return (
        <>
            <div className='relative flex min-h-screen items-end justify-center' id="hero">
                <motion.img src={profilePic} alt={PROFILE.name} className="absolute inset-0 
        z-10  h-full w-full object-cover "
                ...
                <motion.div className="absolute inset-0 z-10 bg-gradient-to-b from-transparent
                from-60 to-black lg:from-30%"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 1 }}
                > </motion.div>

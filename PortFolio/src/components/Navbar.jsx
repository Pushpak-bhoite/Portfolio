    ...
    return (
        <div>
            <nav className="fixed left-0 right-0 top-4 z-50">
                ...
                {/* Mobile Menu */}
                 <div className="rounded-lg backdrop-blur-md lg:hidden">  {/* by default you'll see this section  */}
                    ...
                    {isMobileMenuOpen && (
                        <ul className="ml-4 mt-4 flex flex-col gap-4 backdrop-blur-md">
                            {NAVIGATION_LINKS.map((item, index) => (
                                <li key={index}>
                                    <a className="block w-full text-xl
                                     font-semibold" href={item.href} onClick={(e) =>
